...
- [D-050 — Per-user versioned Windows installation with deep verification before activation](decisions/D-050-stage-9-versioned-windows-installation.md)
- [D-051 — Fail-closed Project Store migration preparation and recovery](decisions/D-051-stage-9-project-store-migration-recovery.md)
- [D-052 — Curated Windows media payload excludes upstream Qt test/build artifacts](decisions/D-052-curated-windows-media-payload.md)
- [D-053 — Versioned installer as the Stage 9 update and rollback carrier](decisions/D-053-versioned-installer-update-rollback.md)
- [D-054 — Secret-safe product diagnostics and recovery health](decisions/D-054-stage-9-product-diagnostics-recovery-health.md)
- [D-055 — Installed clean-machine runtime independence proof](decisions/D-055-stage-9-installed-clean-machine-proof.md)
