...
class WhisperCppRegistryTests(unittest.TestCase):
    ...
    def test_offer_requires_model_after_runtime_is_found(self) -> None:
        with mock.patch.dict("os.environ", {}, clear=True), mock.patch(
            "uv_studio.capabilities.builtin.shutil.which", return_value="/tools/whisper-cli"
        ):
            offer = self._offer()
    ...
    def test_offer_is_available_with_configured_runtime_and_model_without_leaking_paths(self) -> None:
