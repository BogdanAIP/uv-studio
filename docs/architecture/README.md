...
9. `project-context/decisions/D-070-product-first-architecture-compression-gate.md` — post-Stage-18 sequencing authority: architecture-compression inventory and the golden product vertical gate precede D-066 layers 5–7.
10. `project-context/decisions/D-033-reuse-first-scriptable-editor-foundation.md` — editor/MLT ownership foundation.
11. `ARCHITECTURE_PRINCIPLES.md` — repository-wide engineering constraints.
...
- D-070 — current product-first architecture-compression and golden-vertical sequencing authority;
